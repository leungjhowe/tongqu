...
export default function NewProjectCapsule({ onClick }: NewProjectCapsuleProps) {
  return (
    <button
      ...
      onClick={onClick}
      title="新建项目"
      className="group flex flex-col items-center justify-center gap-2 w-[200px] h-[150px] rounded-lg border-2 border-dashed border-capsule-border-active/50 bg-transparent hover:border-solid hover:border-capsule-border-active hover:bg-capsule-bg/0.4 hover:scale-[1.02] transition-[transform,border-color,background-color] duration-base cursor-pointer"
    >
