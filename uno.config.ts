...
export default defineConfig({
  ...
  theme: {
    ...
    fontSize: {
      ...
      'body': ['15px', { 'line-height': '1.55', 'font-weight': '400' }],
      'body-sm': ['14px', { 'line-height': '1.55', 'font-weight': '400' }],
      'caption': ['13px', { 'line-height': '1.40', 'font-weight': '500', 'letter-spacing': '0.005em' }],
      'micro': ['12px', { 'line-height': '1.30', 'font-weight': '500', 'letter-spacing': '0.01em' }],
